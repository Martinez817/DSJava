...
public class QuizScores {
    public static void main(String[] args) {
        ...
        while (true){
            System.out.printf("%nHow would you like to use this program today?%n%nENTER = Enter and store up to 100 scores. %nDROP - Drops the Lowest Score entered. %nAVERAGE - Finds the Average of the current scores entered. %nTEST - Provides Test Averages unrelated to the entered quiz scores %nQUIT - Quit the Program.  %n");
    ...
    class Quizes {
        ...
        public static void enterScores() {
            ...
            public static void printScores(){
                ...
                System.out.print("The Current Quiz Scores are as follows: "); 
            ...
            public static void average(){
                ...
                System.out.printf("Based on the scores entered, the average is: %4.2f %n", finAv); 
            }
